...
const issueListLabelsOnIssue = async ({zParser}) => {
    ...
    const listLabelsOnIssueData = await zGithub.issues.listLabelsOnIssue({
    ...
    return module.exports = {
        zLabelsOnIssue: labels,
    }
}

module.exports = {
    issueListLabelsOnIssue,
}
